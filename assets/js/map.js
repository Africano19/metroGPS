...
function calcRoute(startRoute, endRoute){
  ...
  var request = {
    origin:  { lat: parseFloat(startRoute.coordinates[1]), lng: parseFloat(startRoute.coordinates[0]) },
    destination: { lat: parseFloat(endRoute.coordinates[1]), lng: parseFloat(endRoute.coordinates[0]) },
